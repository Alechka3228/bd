...
DROP TABLE IF EXISTS public."Storages_types" CASCADE;
...
CREATE TABLE IF NOT EXISTS public."Storages_types"
(
    type_id serial,
...
ALTER TABLE IF EXISTS public."Racks"
...
ALTER TABLE IF EXISTS public."Storages"
    ...
    REFERENCES public."Racks" (shelf_id)
    ON UPDATE CASCADE
    ON DELETE CASCADE
    NOT VALID;
...
ALTER TABLE IF EXISTS public."Storages"
    ...
    REFERENCES public."Storages_types" (type_id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE RESTRICT
    NOT VALID;
...
ALTER TABLE IF EXISTS public."Products"
    ...
    REFERENCES public."Storages" (storage_id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE RESTRICT
    NOT VALID;
